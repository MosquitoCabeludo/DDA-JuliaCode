...
3) Conjugated Gradients, which takes longer but solves cases for which the fixed point method failed to converge, for example negative dieletric constants.
